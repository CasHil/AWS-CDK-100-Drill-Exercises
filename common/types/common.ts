 ...
 */
export const allowedAllIpV6AddressRanges = ["::/1", "8000::/1"];
export const allowedAllIpV4AddressRanges = ["0.0.0.0/1", "128.0.0.0/1"];
export const allowedCountryCodesJP = ["JP"];

export type CronExpression =
  `cron(${string} ${string} ${string} ${string} ${string} ${string})`;
