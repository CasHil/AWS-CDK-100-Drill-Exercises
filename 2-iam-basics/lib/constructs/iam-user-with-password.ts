...
export class IAMUserWithPassword extends Construct {
  constructor(scope: Construct, id: string, props: ConstructProps) {
    ...
    const userWithSecretsManagerSecret = new secretsmanager.Secret(
      this,
      `PasswordSecrets`,
      {
    ...
    new cdk.CfnOutput(this, "SecretsPasswordUserSecretArn", {
      ...
      description:
        "The ARN of the Secrets Manager secret for SecretsPasswordUser",
    });
    ...
    new cdk.CfnOutput(this, "SecretsPasswordUserName", {
      ...
      description:
        "The user name of the IAM User with Secrets Manager password",
    });
